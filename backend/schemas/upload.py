...
from schemas import TimestampMixin, PaginationParams
...
class UploadResponse(TimestampMixin):
    ...
    processing_status: Literal["pending", "analyzing", "embedding", "completed", "failed"] = Field(
...
class UploadListParams(PaginationParams):
    ...
    processing_status: Literal["pending", "analyzing", "embedding", "completed", "failed"] | None = Field(
        default=None,
